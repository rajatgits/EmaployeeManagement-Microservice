...
import com.rajatraj.apiclient.OrganizationServiceClient;
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	@Override
 	public EmployeeDTO getEmployeeById(Long id) {
		...
		Organization organization = organizationServiceClient.organizationById(employee.getOrganizationId());
